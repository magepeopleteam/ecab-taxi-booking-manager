	...
	if ( ! class_exists( 'MPTBM_Transport_Search' ) ) {
		class MPTBM_Transport_Search {
			...
			public function transport_search_form( $post_id = '', $price_based = '' ) {
				...
				?>
				<div class="mpStyle">
					<div class="mpRow dLayout mptbm_map_form_area ">
				...
				if ( $location_exit ) {
					...
					<div class="filter_item mptbm_booking_item" data-placeholder>
						...
						<div class="fdColumn mptbm_list_details">
							...
							<h2 class="textTheme" data-main-price="<?php echo esc_attr( $raw_price ); ?>"> <?php echo MP_Global_Function::esc_html( $wc_price ); ?></h2>
							<div class="dLayout_xs bgLight" data-collapse="#mptbm_collape_show_info_<?php echo esc_attr( $post_id ); ?>">
								<ul class="list_inline_two">
									<li class="justifyBetween"><h6><?php esc_html_e( 'Engine', 'mptbm_plugin' ); ?> : </h6> <?php echo MP_Global_Function::get_post_info( $post_id, 'mptbm_engine' ); ?></li>
									<li class="justifyBetween"><h6><?php esc_html_e( 'Length', 'mptbm_plugin' ); ?> : </h6><?php echo MP_Global_Function::get_post_info( $post_id, 'mptbm_length' ); ?></li>
									<li class="justifyBetween"><h6><?php esc_html_e( 'Interior Color', 'mptbm_plugin' ); ?> : </h6><?php echo MP_Global_Function::get_post_info( $post_id, 'mptbm_interior_color' ); ?></li>
									<li class="justifyBetween"><h6><?php esc_html_e( 'Exterior Color', 'mptbm_plugin' ); ?> : </h6><?php echo MP_Global_Function::get_post_info( $post_id, 'mptbm_exterior_color' ); ?></li>
									<li class="justifyBetween"><h6><?php esc_html_e( 'Power', 'mptbm_plugin' ); ?> : </h6><?php echo MP_Global_Function::get_post_info( $post_id, 'mptbm_power' ); ?></li>
									<li class="justifyBetween"><h6><?php esc_html_e( 'Transmission', 'mptbm_plugin' ); ?> : </h6><?php echo MP_Global_Function::get_post_info( $post_id, 'mptbm_transmission' ); ?></li>
									<li class="justifyBetween"><h6><?php esc_html_e( 'Fuel Type', 'mptbm_plugin' ); ?> : </h6><?php echo MP_Global_Function::get_post_info( $post_id, 'mptbm_fuel_type' ); ?></li>
									<li class="justifyBetween"><h6><?php esc_html_e( 'Extras', 'mptbm_plugin' ); ?> : </h6><?php echo MP_Global_Function::get_post_info( $post_id, 'mptbm_extras' ); ?></li>
								</ul>
							</div>
							<div class="divider"></div>
							<form method="post" action="">
								...
								<div data-collapse="#mptbm_collape_select_<?php echo esc_attr( $post_id ); ?>">
									<?php $extra_services = MP_Global_Function::get_post_info( $post_id, 'mptbm_extra_service_data', array() ); ?>
									<div class="mptbm-extra-service-area" data-placeholder>
										<table class="noShadow">
											...
											<?php foreach ( $extra_services as $service ) { ?>
												...
												$service_price     = MP_Global_Function::wc_price( $post_id, $service_price );
												...
												<tr>
													...
													<td class="textCenter"><?php echo MP_Global_Function::esc_html( $service_price ); ?></td>
													<td>
														<label class="_allCenter_fRight selectCheckbox">
															<input type="hidden" name="mptbm_extra_service[]" value=""/>
															<input type="checkbox" data-extra-service-price="<?php echo esc_attr( $service_price_raw ); ?>" value="<?php echo MP_Global_Function::esc_html( $service_name ); ?>"/>
					...
					<div class="search-item">
						<div class="sidebar">
							...
							<div class="sidebar-topic-value">
								<?php echo date( MP_Global_Function::date_format(), strtotime( $search_info['start_date'] ) ); ?>
							</div>
							<div class="divider"></div>
							<div class="sidebar-topic">
									...
									<div id="product-details" class="mptbm_booking_item">
										...
										<div class="details-item">
											<div class="select-div">
												<h2 class="textTheme"> <?php echo MP_Global_Function::esc_html( $product_info['wc_price'] ); ?></h2>
															...
															<?php if ( ! is_null( $extra_services ) && count( $extra_services ) ) { ?>
																<div class="mptbm-extra-service-area" data-placeholder>
																					...
																					<th>
																						<div class="extra-service-name">
																							<h6>
																								...
																								<?php echo MP_Global_Function::esc_html( $service_name ); ?>
																								<span> - </span>
																								<span class="price-text"><?php echo MP_Global_Function::esc_html( $service_price ); ?></span>
																							</h6>
																						</div>
																						<?php
																							if ( $description ) {
                                                                    ...
                                                                    <?php esc_html_e( 'view more ', 'mptbm_plugin' ); ?>
																					...
																					<td class="textCenter">
																						<div id="quantity_<?php echo str_replace( ' ', '_', MP_Global_Function::esc_html( $service_name ) ); ?>" class="quantity-class hide-quantity-box">
																							<?php //echo MP_Custom_Layout::quantity_box( 'mptbm_extra_service_quantity[]' ); ?>
																						</div>
																					</td>
																					<td>
																						<label class="_allCenter_fRight selectCheckbox" data-extra-service-id="<?php echo str_replace( ' ', '_', MP_Global_Function::esc_html( $service_name ) ); ?>">
																							<input type="hidden" name="mptbm_extra_service[]" value=""/>
																							<input type="checkbox" data-extra-service-price="<?php echo esc_attr( $service_price_raw ); ?>" value="<?php echo MP_Global_Function::esc_html( $service_name ); ?>"/>
																							<span class="customCheckbox"><?php esc_html_e( 'Select', 'mptbm_plugin' ); ?></span>
																						</label>
															...
															<div class="booking-part">
																<div class="cart-add-item">
																	<table id="booking-total">
																		<tr>
																			<td>
																				<h4 class="textTheme"><span class="total-amount-text"> Total Amount : </span> <span data-main-price="<?php echo esc_attr( $product_info['raw_price'] ); ?>"><?php echo MP_Global_Function::esc_html( $product_info['wc_price'] ); ?></span></h4>
																			</td>
																			<td>
																				<button class="_dButton_fRight mptbm_book_now" type="button">
																					<?php esc_html_e( 'Add to Cart', 'mptbm_plugin' ); ?>
