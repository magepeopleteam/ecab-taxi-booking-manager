            ...
            if ($transport_id > 0) {
                ...
                if ($price_based === 'manual') {
                    ...
                    if (is_array($manual_prices)) {
                        if (!empty($start_place)) {
                            ...
                            foreach ($manual_prices as $price) {
                                if (!in_array($price['start'], $start_locations)) {
                                    $start_locations[] = $price['start'];
                                }
                            }
                ...
                foreach ($transports as $transport) {
                    ...
                    if ($price_based === 'manual') {
                        ...
                        if (is_array($manual_prices)) {
                            foreach ($manual_prices as $price) {
                                if (!in_array($price['start'], $all_locations)) {
                                    $all_locations[] = $price['start'];
                                }
                                if (!in_array($price['end'], $all_locations)) {
                                    $all_locations[] = $price['end'];
                                }
                            }
                        }
                    }
