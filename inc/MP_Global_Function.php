	...
	if (!class_exists('MP_Global_Function')) {
		class MP_Global_Function {
			...
			public static function get_style_settings($key, $default = '') {
				return MP_Global_Function::get_settings('mp_style_settings', $key, $default);
			}
			public static function get_slider_settings($key, $default = '') {
				return MP_Global_Function::get_settings('mp_slider_settings', $key, $default);
			}
			public static function get_image_url($post_id = '', $image_id = '', $size = 'full') {
				if ($post_id) {
					$image_id = MP_Global_Function::get_post_info($post_id, 'mp_thumbnail');
			...
			public static function get_faq($post_id) {
				return MP_Global_Function::get_post_info($post_id, 'mp_faq', array());
			}
			public static function get_why_choose_us($post_id) {
				return MP_Global_Function::get_post_info($post_id, 'mp_why_choose_us', array());
			}
