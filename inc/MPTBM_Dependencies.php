...
if (!class_exists('MPTBM_Dependencies')) {
    class MPTBM_Dependencies
    {
        ...
        private function load_file(): void
        {
            ...
            require_once MPTBM_PLUGIN_DIR . '/inc/MPTBM_Availability.php';
        ...
        public function frontend_enqueue()
        {
            ...
            wp_enqueue_style('mptbm_availability_styles', MPTBM_PLUGIN_URL . '/assets/frontend/availability-styles.css', array(), time());
