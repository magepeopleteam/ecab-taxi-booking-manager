			...
			<div class="fdColumn _fullWidth mptbm_list_details">
				...
				<div class="justifyBetween _mT_xs">
					...
					<div class="_min_150_mL_xs">
						...
						<button type="button" class="_dButton_xs_w_150 mptbm_transport_select" data-transport-name="<?php echo get_the_title($post_id); ?>" data-transport-price="<?php echo esc_attr($raw_price); ?>" data-post-id="<?php echo esc_attr($post_id); ?>" data-open-text="<?php esc_attr_e('Select Car', 'mptbm_plugin'); ?>" data-close-text="<?php esc_html_e('Selected', 'mptbm_plugin'); ?>" data-open-icon="" data-close-icon="fas fa-check">
