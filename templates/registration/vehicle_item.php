...
?>
        ...
        <div class="_dLayout_dFlex mptbm_booking_item  <?php echo 'mptbm_booking_item_' . $post_id; ?> <?php echo $hidden_class; ?> <?php echo $feature_class; ?>" 
            data-placeholder 
            data-price="<?php echo esc_attr($raw_price); ?>" 
            data-passengers="<?php echo esc_attr($max_passenger); ?>" 
            data-bags="<?php echo esc_attr($max_bag); ?>">
