	...
	$(document).ready(
		function()
		{
			...
			$('.mpStyles .checkout .open-modal').click(function() {
				...
				{
					$('.mpStyles .checkout #field-modal #mptbm_pro_checkout_field_edit_nonce').prop( "disabled", true );
					$('.mpStyles .checkout #field-modal #mptbm_pro_checkout_field_add_nonce').prop( "disabled", false );
				...
				{
					$('.mpStyles .checkout #field-modal #mptbm_pro_checkout_field_edit_nonce').prop( "disabled", false );
					$('.mpStyles .checkout #field-modal #mptbm_pro_checkout_field_add_nonce').prop( "disabled", true );
