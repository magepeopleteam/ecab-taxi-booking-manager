						...
						<form method="post" action="">
							<div class="mpTabsNext">
								<div class="tabListsNext _max_700_mAuto">
									<div data-tabs-target-next="#mptbm_qs_welcome" class="tabItemNext">
										<h4 class="circleIcon">1</h4>
										<h5 class="circleTitle"><?php esc_html_e( 'Welcome', 'mptbm_plugin' ); ?></h5>
									</div>
									<div data-tabs-target-next="#mptbm_qs_general" class="tabItemNext">
										<h4 class="circleIcon">2</h4>
										<h5 class="circleTitle"><?php esc_html_e( 'General', 'mptbm_plugin' ); ?></h5>
									</div>
									<div data-tabs-target-next="#mptbm_qs_done" class="tabItemNext">
										<h4 class="circleIcon">3</h4>
										<h5 class="circleTitle"><?php esc_html_e( 'Done', 'mptbm_plugin' ); ?></h5>
									</div>
								</div>
								...
								<div class="justifyBetween">
									<button type="button" class="mpBtn nextTab_prev"><span>&longleftarrow;<?php esc_html_e( 'Previous', 'mptbm_plugin' ); ?></span></button>
									<div></div>
									<button type="button" class="themeButton nextTab_next"><span><?php esc_html_e( 'Next', 'mptbm_plugin' ); ?>&longrightarrow;</span></button>
								</div>
							</div>
						</form>
					</div>
					...
					<div class="section">
						...
						<div class="_dLayout_mT">
							<label class="fullWidth">
								<span class="min_200"><?php esc_html_e( 'Transportation Label:', 'mptbm_plugin' ); ?></span> <input type="text" class="formControl" name="mptbm_label" value='<?php echo esc_attr( $label ); ?>'/>
							</label>
							<i class="info_text"> <span class="fas fa-info-circle"></span>
								<?php esc_html_e( 'It will change the Transportation post type label on the entire plugin.', 'mptbm_plugin' ); ?>
							</i>
							<div class="divider"></div>
							<label class="fullWidth">
								<span class="min_200"><?php esc_html_e( 'Transportation Slug:', 'mptbm_plugin' ); ?></span> <input type="text" class="formControl" name="mptbm_slug" value='<?php echo esc_attr( $slug ); ?>'/>
							</label>
							<i class="info_text"> <span class="fas fa-info-circle"></span>
