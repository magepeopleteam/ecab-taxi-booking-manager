            ...
            ?>
                <div class="tab-content" id="mptbm_wc_order_field_settings">
                    ...
                    <div class="action-button">
                        <a class="button open-modal" data-action="add" data-key="order">
						...
						<tbody>
                            ...
                            <?php foreach ($contents['order'] as $key => $checkout_field) : ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="button button-small button-secondary open-modal" data-action="edit" data-key="order" data-name="<?php echo esc_attr(esc_html($key))?>">Edit</a>
                                        <?php if(isset($checkout_field['custom_field'])) : ?>
                                        <a class="button button-small button-link-delete" href="<?php echo esc_attr(wp_nonce_url(admin_url('edit.php?post_type=mptbm_rent&page=mptbm_wc_checkout_fields&action=delete&key=' . esc_html('order').'&name=' . esc_html($key)), 'mptbm_checkout_field_delete', 'mptbm_checkout_field_delete_nonce')); ?>" class="delete" onclick="return confirm(esc_attr('Are you sure you want to delete this field?'))">Delete</a>
                                        <?php endif ?>
                                    </td>
                                </tr>
